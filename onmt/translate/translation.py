...
class Translation(object):
    ...
    def log(self, sent_number, json_output=False):
        """
        Log translation.
        """
        ...
        if json_output:
            output = '{{"metric": "pred score", "value": {}, "step": {}}}\n'.format(best_score, sent_number)
        else:
        ...
        if self.gold_sent is not None:
            ...
            if json_output:
                output += '{{"metric": "gold score", "value": {}, "step": {}}}\n'.format(self.gold_score, sent_number)
            else:
                output += 'GOLD {}: {}\n'.format(sent_number, tgt_sent)
                output += ("GOLD SCORE: {:.4f}\n".format(self.gold_score))

        if len(self.pred_sents) > 1 and not json_output:
            output += '\nBEST HYP:\n'
